/// temporary models, nanti diganti dari app Readlist
...
List<Readlist> readlistFromJson(String str) => List<Readlist>.from(json.decode(str).map((x) => Readlist.fromJson(x)));

String readlistToJson(List<Readlist> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
